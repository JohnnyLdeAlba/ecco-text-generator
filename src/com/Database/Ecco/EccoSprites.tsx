...
export const EccoSprites = container => {

  let node = null

  node = container.addNode('',
    RootDir.EccoSpritesId);
  node.name = "Alphabet";
  node.type = "download";
  ...
  node.name = "Eel";
  node.type = "download";
  node.icon = "/eccoserv/ecco-the-dolphin/sprite-sheets/icons/eel.png";
  node.value = "/eccoserv/ecco-the-dolphin/sprite-sheets/eel.png";
  ...
  node.name = "Objects";
  node.type = "download";
  node.icon = "/eccoserv/ecco-the-dolphin/sprite-sheets/icons/objects.png";
  node.value = "/eccoserv/ecco-the-dolphin/sprite-sheets/objects.png";
  ...
  node.type = "download";
  node.icon = "/eccoserv/ecco-the-dolphin/sprite-sheets/icons/health-bar.png";
  node.value = "/eccoserv/ecco-the-dolphin/sprite-sheets/health-bar.png";

  node = container.addNode('',
    RootDir.EccoSpritesId);
  node.name = "Prehistoric Jellyfish";
  node.type = "download";
  ...
  node.value = "/eccoserv/ecco-the-dolphin/sprite-sheets/shark.png";
  ...
  node.type = "download";
  node.icon = "/eccoserv/ecco-the-dolphin/sprite-sheets/icons/sonar-rings.png";
  node.value = "/eccoserv/ecco-the-dolphin/sprite-sheets/sonar-rings.png";
